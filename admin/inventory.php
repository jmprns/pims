  ...
  <nav class="navbar navbar-inverse" style="margin-top:-18px;">
  	<div class="container-fluid">
  	  ...
  	  <ul class="nav navbar-nav">
  	    ...
  	    <li>
          <a href="item.php"><span class="glyphicon glyphicon-object-align-vertical"></span> Item Assignment
          </a>
        </li>

        <li class="active">
          <a href="inventory.php"><span class="glyphicon glyphicon-object-align-vertical"></span> Inventory
          </a>
        </li>
        ...
        <li>
          <a href="room.php"><span class="glyphicon glyphicon-home"></span> Room</a>
        </li>
