			...
			<div class="modal-body">
				<!-- main form -->
					...
					<input type="hidden" id="update-eid">
					  ...
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="update-room">Room:</label>
					    <div class="col-sm-9">
					      <select class="btn btn-default" id="update-room">
					      	<?php 
					      		foreach ($rooms as $rm) {
					      			# code...
					      			$rm_id = $rm['rm_id'];
					      			$rm_desc = $rm['rm_desc'];
					      	?>
					      		<option value="<?php echo $rm_id; ?>"><?php echo $rm_desc; ?></option>
					      	<?php		
					      		}//end foreach
					      	 ?>
					      </select>
