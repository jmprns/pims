			...
			<div class="modal-body">
				<!-- main form -->
					...
					<input type="hidden" id="iID">
					  ...
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="propertyNumber-update">Property No.:</label>
					    <div class="col-sm-9"> 
					      <input type="text" class="form-control" id="propertyNumber-update" placeholder="Enter Property No">
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-9"> 
					      <input type="number" step="any"  class="form-control" id="quantity-update" placeholder="Enter Quantity">
					    </div>
					  </div>		

					   <div class="form-group">
					    <label class="control-label col-sm-3" for="rcvDate-update">Recieve Date:</label>
					    <div class="col-sm-9"> 
					      <input type="date" class="form-control" id="rcvDate-update">
					    </div>
					  </div>	
