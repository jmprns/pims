	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Item Assignment</h4>
			</div>
				...
				<!-- main form -->
					...
					<div class="form-group">
					  ...
					  <div class="form-group" id="sr">
					    <label class="control-label col-sm-3" for="propertyNumber">Property No.:</label>
					    <div class="col-sm-9"> 
					      <input type="text" class="form-control" id="propertyNumber" placeholder="Enter Property No">
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-9"> 
					      <input type="number" step="any"  class="form-control" id="quantity" placeholder="Enter Quantity">
					    </div>
					  </div>		

					   <div class="form-group">
					    <label class="control-label col-sm-3" for="rcvDate">Recieve Date:</label>
					    <div class="col-sm-9"> 
					      <input type="date" class="form-control" id="rcvDate" >
					    </div>
					  </div>	
