...
<html>
<head>
	<title>Property Inventory System</title>
 <meta charset="utf-8">
...
<nav class="navbar navbar-inverse" style="margin-top:5px;">
    <div class="container-fluid">
     <div class="banner">
                    <!--<img src="img/wlogo.png" width="200" height="90" style="position:absolute;margin-top:-20px;">-->
<div style="color:white;margin-left:250px;margin-bottom:50px;margin-top:20px;font-size:40px;font-family:Franklin Gothic Heavy;">Inventory System</div>
