...
class Item extends Database implements iItem{
	...
	{
		$sql = "INSERT INTO tbl_item(item_name, item_ptyno, item_modno, item_brand, item_quantity, item_rcvdate, emp_id, cat_id, con_id)
				VALUES(?,?,?,?,?,?,?,?,?);
		";
	...
	{
		/*get all items with the room nga naa sa emp*/
		$sql = "SELECT *
				FROM tbl_item i
				INNER JOIN tbl_employee e
				ON i.emp_id = e.emp_id
